...
public class MaiFormController {
    ...
    public JFXButton btnSentMessage;
    ...
    public void initialize(){
        ...
        btnSentMessage.setDisable(true);
        try {
    ...
    public void sendMessageKeyAction(ActionEvent actionEvent) throws IOException {
    ...
    public void sendMessageOnAction(ActionEvent actionEvent) throws IOException {
        sendMessageKeyAction(actionEvent);
    }
    ...
    public void txtNameOnAction(ActionEvent actionEvent) {
        ...
        if(matcher.matches()){
            ...
            btnSentMessage.setDisable(false);
            txtName.setEditable(false);
            txtMessage.setVisible(true);
        }
    }

    public void btnChooseImgOnAction(ActionEvent actionEvent) {
